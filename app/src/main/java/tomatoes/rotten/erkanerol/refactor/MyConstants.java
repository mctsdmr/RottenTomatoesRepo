...
public class MyConstants {
    ...
    public static final int FRAGMENT_TYPE_IN_THEATERS =1;
    public static final int FRAGMENT_TYPE_OPENING_MOVIES =2;
    public static final int FRAGMENT_TYPE_UPCOMING_MOVIES =3;
    public static final int FRAGMENT_TYPE_TOP_RENTALS =4;
    ...
    public static final String GET_API_KEY="apikey";
    public static final String GET_API_VALUE="dzsdnwhb5hj2pb68v7bubaz6";
    ...
    public static final String GET_SEARCH_KEY="q";
    ...
    public static final String GET_COUNTRY_TEXT ="country";
    public static final String GET_PAGE_LIMIT="page_limit";
    public static final String GET_LIMIT="limit";
